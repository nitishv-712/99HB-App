...
class _ComparisonTile extends StatelessWidget {
  ...
  const _ComparisonTile(
      {required this.comparison, required this.onDelete});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Navigator.push(
        ...
        MaterialPageRoute(
            builder: (_) =>
                ComparisonDetailScreen(comparisonId: comparison.id)),
      ),
      child: Container(
...
class ComparisonDetailScreen extends StatefulWidget {
  ...
  @override
  State<ComparisonDetailScreen> createState() =>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
        (_) => context
            ...
            .fetchDetail(widget.comparisonId));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppStandardBar(
        title: context.watch<ComparisonsProvider>().detail?.name ??
            'Comparison',
      ),
      body: Consumer<ComparisonsProvider>(
        builder: (_, prov, __) {
          ...
          final properties =
              detail.propertyIds.whereType<ApiProperty>().toList();
