    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.favorite_border_rounded, size: 16, color: cs.onSurface),
                    ),
                  ),
                ],
              ),
          ...
          Text(property.title,
              style: GoogleFonts.notoSerif(fontSize: 15, fontWeight: FontWeight.bold, color: cs.onSurface),
          ...
          Row(children: [
            ...
            Expanded(
              child: Text(property.locationString,
