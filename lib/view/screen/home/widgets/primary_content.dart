  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('${property.saves}', style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 13)),
                  const SizedBox(width: 2),
                  Text('saves', style: GoogleFonts.inter(fontSize: 11, color: cs.onSurfaceVariant)),
                ],
              ),
            ),
          ],
        ...
        Text(
          property.priceLabel.isNotEmpty ? property.priceLabel : '₹ ${property.price.toStringAsFixed(0)}',
        ...
        Wrap(
          ...
          children: [
            DetailStatItem(icon: Icons.bed_outlined, label: 'Bedrooms', value: '${property.bedrooms}'),
            if (property.bathrooms != null)
              DetailStatItem(icon: Icons.bathtub_outlined, label: 'Bathrooms', value: '${property.bathrooms}'),
            DetailStatItem(icon: Icons.square_foot_outlined, label: 'Built Area', value: '${property.sqft.toStringAsFixed(0)} sqft'),
            if (property.yearBuilt != null)
              DetailStatItem(icon: Icons.calendar_today_outlined, label: 'Year Built', value: '${property.yearBuilt}'),
          ],
        ),
...
class DetailStatItem extends StatelessWidget {
  ...
  final String label;
  final String value;
  const DetailStatItem({super.key, required this.icon, required this.label, required this.value});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(value, style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.bold, color: cs.onSurface)),
          const SizedBox(height: 2),
          Text(label, style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w600, letterSpacing: 0.5, color: cs.onSurfaceVariant.withOpacity(0.6))),
        ],
      ),
    );
  }
...
class DetailInfoCard extends StatelessWidget {
  ...
  final String title;
  final Widget child;
  const DetailInfoCard({super.key, required this.icon, required this.title, required this.child});
