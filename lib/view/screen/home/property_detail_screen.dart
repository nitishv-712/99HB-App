    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Property Details',
            style: GoogleFonts.notoSerif(fontSize: 18, fontWeight: FontWeight.w900, color: cs.onSurface, letterSpacing: -0.3)),
        centerTitle: true,
        actions: [
          if (widget.propertyId != null)
            Consumer<SavedProvider>(
              builder: (_, saved, __) {
                ...
                return IconButton(
                  ...
                  onPressed: () => context.read<SavedProvider>().toggle(widget.propertyId!),
                );
              },
            ),
        ],
                    ...
                    child: Padding(
                      ...
                      child: isWide
                          ? Row(
                              ...
                              children: [
                                Expanded(flex: 8, child: DetailPrimaryContent(property: prov.detail!)),
                                const SizedBox(width: 48),
                                SizedBox(width: 360,
                                    child: DetailSidebar(property: prov.detail!, messageCtrl: _messageCtrl)),
                              ],
                            )
                          : Column(
                              children: [
                                ...
                                DetailSidebar(property: prov.detail!, messageCtrl: _messageCtrl),
                                const SizedBox(height: 32),
                                DetailReviewsSection(propertyId: prov.detail!.id),
                              ],
                            ),
                    ),
                  ),
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(prov.detailError!, style: GoogleFonts.inter(color: cs.onSurfaceVariant), textAlign: TextAlign.center),
                          const SizedBox(height: 16),
                          TextButton(onPressed: () => prov.fetchDetail(widget.propertyId!), child: const Text('Retry')),
                        ],
                      ),
                    ),
                  ),
